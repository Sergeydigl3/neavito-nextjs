...
const CategoriesSection: React.FC = () => {
    return (
        <section className="bg-gray-100 dark:bg-zinc-300 py-12 md:py-20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <h2 className="dark:text-black text-2xl font-semibold mb-6">Categories</h2>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="dark:text-black bg-white rounded-lg shadow p-4 flex flex-col items-center">
